...
import 'package:quickdep_mob/resource/components/card/shift/public_shift_card.dart';
...
class ShiftList extends StatefulWidget {
  ...
  @override
  State<ShiftList> createState() => _ContractListState();
}

class _ContractListState extends State<ShiftList> {
